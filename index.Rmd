...
bibs <- c('knitcitations' = citation('knitcitations'),
    tidyr = RefManageR::BibEntry('article', title = 'Tidy Data', author = 'Hadley Wickham', year = 2014, journal = 'Journal of Statistical Software', url = 'http://www.jstatsoft.org/v59/i10/paper'),
    reproducibility = RefManageR::BibEntry('article', title = 'Reproducible Research in Computational Science', author = 'Roger D. Peng', year = 2011, journal = 'Science', url = 'http://www.sciencemag.org/content/334/6060/1226'),
    R = citation(),
